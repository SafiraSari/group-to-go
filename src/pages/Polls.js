      ...
      <div className="polls-container">
        ...
        {modalOpen && (        
          <Modal onSubmit={handleButtonClick} onCancel={handleButtonClick} onClose={handleButtonClick} >
            ...
            <Input label="Enter the Poll Name" placeholder="Poll Name" isRequired />

            <Input label="Enter the Group ID" placeholder="GroupID" isRequired />

            <Input label="Enter the Poll Question" placeholder="Question" isRequired />
            ...
            <Input label="Enter any additional details" type="text" placeholder="Notes" />
          </Modal>
        )}
      </div>
    </>
